    ...
    return (
        rx.flex(
                ...
                rx.flex(
                    rx.flex(
                        ...
                        rx.flex(
                            ...
                            direction='column',
                            style={"z-index": "20", "position": "relative", "top": "0", "left": "0"},
                    ...
                    rx.flex(
                        ...
                        rx.flex(
                            ...
                            direction='column',
                            style={"z-index": "15", "position": "relative", "top": "0", "left": "0"},
                    ...
                    rx.flex(
                        ...
                        rx.flex(
                            ...
                            direction='column',
                            style={"z-index": "10", "position": "relative", "top": "0", "left": "0"},
            ...
            rx.card(
                rx.flex(
                    rx.flex(
                        rx.image(src="/warning.svg", style={"width": "2.5em", "height": "2.5em"}),
                        rx.text("Zero Performers Found", size="2", weight="medium"),
                        direction="row",
                        align="center",
                        spacing="2"
                    ),
                    rx.button("Close", on_click=[MainController.change_performer_error_style("hidden")], bg="yellow",
                              style={"color": "black"}),
                    style={"z-index": "25", "position": "absolute", "padding": "0.6em", "margin-top": "0em",
                           "visibility": MainController.performer_error_style, "border": f"0.13em solid yellow",
                           "border-radius": "0.5em", "margin-left": "25em"},
                    bg=rx.color("yellow", 7),
                    direction="column",
                    spacing="2",
                ),
                rx.flex(
